...
import { installConnectSessionHandlersFromGame } from '../connect/registrations-builder';
import { handleConnectStartupTail } from '../connect/tail';
import { installPlayerAggroHandlers } from '../player/aggro';
import { installPlayerBeforeStepHandler } from '../player/before-step';
import { installPlayerCosmeticHandlersFromGame } from '../player/cosmetics-builder';
import { installPlayerDeathHandler } from '../player/death';
import { installPlayerStartPathingHandler } from '../player/pathing';
import { installPlayerRequestPathHandler } from '../player/request-path';
import { installPlayerStepHandler } from '../player/step';
import { installPlayerStopPathingHandler } from '../player/stop-pathing';
