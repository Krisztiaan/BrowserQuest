...
type AchievementStorage = Pick<
    Storage,
    'getRatCount' | 'getSkeletonCount' | 'getTotalKills' | 'getTotalRevives' | 'getTotalDamageTaken'
>;

export function createAchievementDefinitions(storage: AchievementStorage): Record<string, AchievementDefinition> {
