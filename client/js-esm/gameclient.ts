...
/** @typedef {import('./client-boundary-types').ClientInboundProtocolAction} ClientInboundProtocolAction */
/** @typedef {import('./client-boundary-types').ClientOutboundProtocolAction} ClientOutboundProtocolAction */
...
class GameClient {
    ...
    /**
     * @param {ClientOutboundProtocolAction} json
     */
    sendMessage(json) {
        var data;
    ...
    /**
     * @param {ClientInboundProtocolAction} data
     */
    receiveAction(data) {
        var action = data[0];
