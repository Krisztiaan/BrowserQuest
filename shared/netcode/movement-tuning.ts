...
export const MOVEMENT_TUNING_PROFILES: Readonly<Record<MovementTuningProfileId, MovementTuningProfile>> = Object.freeze({
    ...
    combat_proximity: Object.freeze({
        ...
        client: Object.freeze({
            ...
            hardReconcileErrSubpx: TILE_SUBPX,
            localPresentationSnapDistancePx: 80,
            localPresentationTauActiveMs: 18,
            localPresentationTauIdleMs: 36,
            localPresentationMinStepPx: 0.75,
            remotePresentationSnapDistancePx: 80,
            remotePresentationTauMs: 68,
            remoteInterpolationDelayMs: 90,
            remoteSnapshotDiscontinuitySubpx: Math.round(TILE_SUBPX * 1.75),
            remoteExtrapolationMaxMs: 60,
            remoteExtrapolationUndershoot: 0.65,
            remoteSnapshotHistoryLimit: 6,
        }),
        server: Object.freeze({
